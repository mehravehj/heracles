...
xticklabels={1, 2-short, 2-1-1, 2-1-2, 2-2-1, 2-2-2, 2-3-1, 2-3-2, 2-4-1, 2-4-2, 3-short, 3-1-1, 3-1-2, 3-2-1, 3-2-2, 3-3-1, 3-3-2, 3-4-1, 3-4-2, 4-short, 4-1-1, 4-1-2, 4-2-1, 4-2-2, 4-3-1, 4-3-2, 4-4-1, 4-4-2, fc1},
...
error plus index=3] {\dataset/wrn_28_4_channel_05.csv};
...
error mark options={line width=0.5pt, mark size=2pt,rotate=90}]
table[col sep=space, x index=0, y index=1, y error minus index=2, y
error plus index=3] {\dataset/wrn_28_4_weight_010.csv};
